...
def index_view(request):
    # __________debugger______________
    print("hi you are in home.html")
...
def chat_view(request):
    ...
    print("after", os.environ["GOOGLE_APPLICATION_CREDENTIALS"])

    GOOGLE_PROJECT_ID = "appointmentscheduler-xxktmx"
...
# __________debugger______________//unused
